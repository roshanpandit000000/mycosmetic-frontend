...
const OrderScreen = () => {
    ...
    return actions.order.capture().then(async function (details) {
      try {
        ...
        const { data } = await axios.put(
          `https://mycosmetic-backend.onrender.com/api/orders/${order._id}/pay`,
          details,
          {
  ...
  useEffect(() => {
    const fetchOrder = async () => {
      try {
        ...
        const { data } = await axios.get(`https://mycosmetic-backend.onrender.com/api/orders/${orderId}`, {
          headers: { authorization: `Bearer ${userInfo.token}` },
        });
    ...
    if (
      ...
      const loadPaypalScript = async () => {
        const { data: clientId } = await axios.get("https://mycosmetic-backend.onrender.com/api/keys/paypal", {
          headers: { authorization: `Bearer ${userInfo.token}` },
        });
        paypalDispatch({
          type: "resetOptions",
  ...
  async function deliverOrderHandler() {
    try {
      ...
      const { data } = await axios.put(
        `https://mycosmetic-backend.onrender.com/api/orders/${order._id}/deliver`,
        {},
        {
          headers: { authorization: `Bearer ${userInfo.token}` },
        }
